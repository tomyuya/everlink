...
CREATE TABLE IF NOT EXISTS audit_log (
  ...
  agent TEXT NOT NULL,
  event TEXT NOT NULL,                   -- tool_call | tool_result | steering_guide | steering_cancel | interrupt | notify | write | write_refused | verify | rollback | dead_letter | worker_error
  payload TEXT
);
